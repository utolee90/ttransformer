...
python -u run.py \
  ...
  --des 'Exp' \
  --itr 1 \
  --moving_avg 25 > logs/LongForecasting/Exchange_RATE_$model_name2'_'tester_$seq_len'_'$pred_len'_'1.log 
